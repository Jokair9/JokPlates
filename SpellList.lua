...
JokPlatesFrameMixin.interrupts = {
    [1766] = 5, -- Kick (Rogue)
...
JokPlatesFrameMixin.nameplates_buffs = {
...
JokPlatesFrameMixin.nameplates_debuffs = {
	-- Azerite
...
JokPlatesFrameMixin.nameplates_personal = {
...
JokPlatesFrameMixin.PowerPrediction = {
    [8] = { -- Astral Power
